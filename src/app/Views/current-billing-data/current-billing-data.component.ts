...
@Component({
  selector: 'app-current-billing-data',
  templateUrl: './current-billing-data.component.html',
  styleUrls: ['./current-billing-data.component.scss']
})
export class CurrentBillingDataComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.service.getCurrentBillingData(this.formdata.fromdate, this.formdata.todate, this.formdata.meterNo).subscribe((res: any) => {
