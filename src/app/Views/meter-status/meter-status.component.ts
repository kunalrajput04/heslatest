...
export class MeterStatusComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.service
      .getMeterStatusData(this.formdata.meterNo)
      .subscribe((res: any) => {
            ...
            for (let item in res.data[0]) {
              if (parseInt(item) !== 1) {
                ...
                this.tableData.push({
                  ...
                  lastUpdatedDateTime: res.data[0][item][1],
                  rtcDateTime: res.data[0][item][2],
                  relayStatus: res.data[0][item][3]
                });
